...
function getHandlers(set, trackMouse) {
  var onStart = function onStart(event) {
    ...
    set.current(function (state, props) {
...
function useSwipeable(props) {
  ...
  var set = react__WEBPACK_IMPORTED_MODULE_0___default.a.useRef();

  set.current = function (cb) {
    return transientState.current = cb(transientState.current, _extends({}, defaultProps, props));
  };
...
function (_React$PureComponent) {
  ...
  function Swipeable(props) {
    ...
    _this._current = function (cb) {
      _this._state = cb(_this._state, _this.props);
    };
  ...
  _proto.render = function render() {
    ...
    var handlers = getHandlers(this._set, trackMouse);
...
var Wallpaper_1 = __webpack_require__(/*! ../Wallpaper/Wallpaper */ "./src/components/Wallpaper/Wallpaper.tsx");
__webpack_require__(/*! ./App.scss */ "./src/components/App/App.scss");
var Time_1 = __webpack_require__(/*! ../Time/Time */ "./src/components/Time/Time.tsx");
var Spotify_1 = __webpack_require__(/*! ../Spotify/Spotify */ "./src/components/Spotify/Spotify.tsx");
var Ticker_1 = __webpack_require__(/*! ../Ticker/Ticker */ "./src/components/Ticker/Ticker.tsx");
var NewsTicker_1 = __webpack_require__(/*! ../NewsTicker/NewsTicker */ "./src/components/NewsTicker/NewsTicker.tsx");
var Weather_1 = __webpack_require__(/*! ../Weather/Weather */ "./src/components/Weather/Weather.tsx");
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement("div", { className: "container" },
            ...
            this.props.displayOnly ? React.createElement(Weather_1.default, null) : null));
    };
    return App;
}(React.Component));
;
...
/***/ "./src/components/NewsTicker/NewsTicker.scss":
/*!***************************************************!*\
  !*** ./src/components/NewsTicker/NewsTicker.scss ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/components/NewsTicker/NewsTicker.tsx":
/*!**************************************************!*\
  !*** ./src/components/NewsTicker/NewsTicker.tsx ***!
  \**************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
__webpack_require__(/*! ./NewsTicker.scss */ "./src/components/NewsTicker/NewsTicker.scss");
var defaultState = {
    news: [],
    currentIndex: 0,
    opacity: 0,
...
/***/ "./src/components/Spotify/Spotify.scss":
/*!*********************************************!*\
  !*** ./src/components/Spotify/Spotify.scss ***!
  \*********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
var react_swipeable_1 = __webpack_require__(/*! react-swipeable */ "./node_modules/react-swipeable/es/index.js");
var rc_progress_1 = __webpack_require__(/*! rc-progress */ "./node_modules/rc-progress/es/index.js");
__webpack_require__(/*! ./Spotify.scss */ "./src/components/Spotify/Spotify.scss");
var Volume_1 = __webpack_require__(/*! ./components/Volume/Volume */ "./src/components/Spotify/components/Volume/Volume.tsx");
var defaultState = {
    artistName: "",
    songName: "",
    playing: false,
...
var Spotify = /** @class */ (function (_super) {
    ...
    function Spotify(props) {
        var _this = _super.call(this, props) || this;
        _this.state = defaultState;
        window.socket.on("spotify", function (data) {
            if (data.currentTrack.name == undefined) {
                _this.setState(defaultState);
                return;
            }
            _this.setState({
                songName: data.currentTrack.name,
                artistName: data.currentTrack.artists[0].name,
                playing: data.isPlaying,
                albumCover: data.currentTrack.album.images[0].url,
                songLength: data.currentTrack.duration_ms,
                currentPos: data.progressMs,
            });
    ...
    Spotify.prototype.forceUpdate = function () {
        window.socket.emit("spotify", { command: "force_update" });
    };
    ...
    Spotify.prototype.previousTrack = function () {
        window.socket.emit("spotify", { command: "previous_track" });
    };
    Spotify.prototype.nextTrack = function () {
        window.socket.emit("spotify", { command: "next_track" });
    };
    Spotify.prototype.ppTrack = function () {
        window.socket.emit("spotify", { command: "playpause" });
    };
    ...
    Spotify.prototype.render = function () {
        return (this.state.playing ? (React.createElement("div", { className: "spotify-container-container-container " + (this.props.displayTop === true ? "top" : "") },
            React.createElement("div", { className: "spotify-container-container", style: !this.state.playing ? { background: 'none' } : { background: "-webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(255,255,255,0)), color-stop(7%, rgba(0,0,0,0.07)), color-stop(100%, rgba(0,0,0,1)))" } },
            ...
            React.createElement(Volume_1.default, { volumeChange: this.volumeChange.bind(this) }))));
    };
    return Spotify;
}(React.Component));
;
...
/***/ "./src/components/Spotify/components/Volume/Volume.scss":
/*!**************************************************************!*\
  !*** ./src/components/Spotify/components/Volume/Volume.scss ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./src/components/Spotify/components/Volume/Volume.tsx":
/*!*************************************************************!*\
  !*** ./src/components/Spotify/components/Volume/Volume.tsx ***!
  \*************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
__webpack_require__(/*! ./Volume.scss */ "./src/components/Spotify/components/Volume/Volume.scss");
var defaultState = {
    volume: 0,
    steps: 0,
    touchStart: -1
...
var Volume = /** @class */ (function (_super) {
    ...
    function Volume(props) {
        var _this = _super.call(this, props) || this;
        _this.updateVolume = function (data) {
            _this.setState({
                volume: data.volume
            });
        };
    ...
    Volume.prototype.componentDidMount = function () {
        window.socket.on("spotify", this.updateVolume);
    };
    Volume.prototype.componentWillUnmount = function () {
        window.socket.removeListener("spotify", this.updateVolume);
    };
    ...
    Volume.prototype.touchEnd = function (e) {
        ...
        this.setState({
            ...
            window.socket.emit("spotify", { command: "set_volume", arg: { volume: _this.state.volume } });
        });
    };
...
/***/ "./src/components/Ticker/Ticker.scss":
/*!*******************************************!*\
  !*** ./src/components/Ticker/Ticker.scss ***!
  \*******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
__webpack_require__(/*! ./Ticker.scss */ "./src/components/Ticker/Ticker.scss");
var defaultState = {
    //0 is date //1 is quote //2 is weather
    strings: ["", "", ""],
    currentIndex: -1,
    opacity: 0,
};
...
var Ticker = /** @class */ (function (_super) {
    ...
    function Ticker(props) {
        var _this = _super.call(this, props) || this;
        _this.state = defaultState;
        window.socket.on("weather", function (weatherData) {
            if (!weatherData.currently || _this.props.temperature == false) {
                return;
            }
            var oldState = _this.state;
            oldState.strings[2] = "<img class=\"weather-icon\" src=\"/static/DarkSky/" + weatherData.currently.icon + ".svg\"/> " + Math.round(weatherData.currently.temperature * 10) / 10 + "&deg;C";
            _this.setState(oldState);
        });
        window.socket.on("quote", function (quote) {
            var oldState = _this.state;
            oldState.strings[1] = quote;
            _this.setState(oldState);
        });
        return _this;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
__webpack_require__(/*! ./Time.scss */ "./src/components/Time/Time.scss");
...
/***/ "./src/components/Wallpaper/Wallpaper.scss":
/*!*************************************************!*\
  !*** ./src/components/Wallpaper/Wallpaper.scss ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/components/Wallpaper/Wallpaper.tsx":
/*!************************************************!*\
  !*** ./src/components/Wallpaper/Wallpaper.tsx ***!
  \************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
__webpack_require__(/*! ./Wallpaper.scss */ "./src/components/Wallpaper/Wallpaper.scss");
...
var Wallpaper = /** @class */ (function (_super) {
    ...
    function Wallpaper(props) {
        ...
        window.socket.on("wallpaper", function (data) {
            _this.setState({
                opacity: 0,
            }, function () { return setTimeout(function () {
                _this.setState({
                    wallpaperUrl: data + "&w=" + screen.width + "&h=" + screen.height,
                }, function () {
                    setTimeout(function () {
                        _this.setState({
                            opacity: 0.8,
    ...
    Wallpaper.prototype.render = function () {
        return (React.createElement("div", { className: "wallpaper", style: { opacity: this.state.opacity, backgroundImage: "url(\"" + this.state.wallpaperUrl + "\")" } }));
    };
    return Wallpaper;
}(React.Component));
;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
__webpack_require__(/*! ./Weather.scss */ "./src/components/Weather/Weather.scss");
var defaultState = {
    current: null,
    forecast: [],
};
